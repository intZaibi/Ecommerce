      ...
      <nav className="flex w-full justify-between items-center bg-white shadow-[0_0_10px_#080f340f] mx-auto lg:py-8 lg:px-52">
        ...
        <div className="flex justify-center items-center">
          <div className='flex items-center cursor-pointer' onClick={toggleDropdown} >
            ...
            <div id="dropdown" className="py-10 w-48 items-center cursor-auto z-10 top-24 flex-col gap-8 rounded-[0_16px_16px_16px] bg-white shadow-[0_40px_20px_#080f341a] absolute hidden">
