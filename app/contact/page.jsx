        ...
        <div id="container" className="gap-5 grid lg:grid-cols-2">
          ...
          >
            ...
            <input
              ...
              />
            <svg id="svg1" className="top-3 lg:top-[12px] right-5 absolute" width="24" height="28" viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_2_2231)"><path d="M11.155 13.6811C14.6568 13.6811 17.4956 10.8424 17.4956 7.34057C17.4956 3.83877 14.6568 1 11.155 1C7.65322 1 4.81445 3.83877 4.81445 7.34057C4.81445 10.8424 7.65322 13.6811 11.155 13.6811Z" stroke="#A0A3BD" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><path d="M1.01025 26.8256C1.01025 24.135 2.07909 21.5546 3.98163 19.652C5.88417 17.7495 8.46457 16.6807 11.1552 16.6807C13.8458 16.6807 16.4262 17.7495 18.3288 19.652C20.2313 21.5546 21.3001 24.135 21.3001 26.8256" stroke="#A0A3BD" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></g><defs><clipPath id="clip0_2_2231"><rect width="23" height="28" fill="white" transform="translate(0.0102539)"/></clipPath></defs></svg>
              </div>
            ...
            <input
              ...
              placeholder="E-mail"
              />
            <svg id="svg2" className="top-4 lg:top-4 right-5 absolute" width="26" height="18" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_2_2240)"><path d="M22.0193 1H3.01929C1.91472 1 1.01929 1.89543 1.01929 3V15C1.01929 16.1046 1.91472 17 3.01929 17H22.0193C23.1239 17 24.0193 16.1046 24.0193 15V3C24.0193 1.89543 23.1239 1 22.0193 1Z" stroke="#A0A3BD" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><path d="M23.4304 1.58203L12.5194 10.5L1.6084 1.58203" stroke="#A0A3BD" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></g><defs><clipPath id="clip0_2_2240"><rect width="25" height="18" fill="white" transform="translate(0.0192871)"/></clipPath></defs></svg>
              </div>
            ...
            <input
              ...
              placeholder="Phone"
              />
            <svg id="svg3" className="top-3 lg:top-[10px] right-5 absolute" width="18" height="28" viewBox="0 0 18 28" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_2_2248)"><path d="M13.845 1H3.67103C2.42239 1 1.41016 2.01223 1.41016 3.26087V24.7391C1.41016 25.9878 2.42239 27 3.67103 27H13.845C15.0936 27 16.1059 25.9878 16.1059 24.7391V3.26087C16.1059 2.01223 15.0936 1 13.845 1Z" stroke="#A0A3BD" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.4611 1V2.48123C12.4611 2.87408 12.3051 3.25083 12.0273 3.52862C11.7495 3.8064 11.3727 3.96246 10.9799 3.96246H6.53615C6.14331 3.96246 5.76655 3.8064 5.48877 3.52862C5.21098 3.25083 5.05493 2.87408 5.05493 2.48123V1" stroke="#A0A3BD" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></g><defs><clipPath id="clip0_2_2248"><rect width="17" height="28" fill="white" transform="translate(0.410156)"/></clipPath></defs></svg>
              </div>
