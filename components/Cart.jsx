  ...
  return (
    <div className='fixed h-[100vh] hidden overflow-hidden overflow-y-scroll z-10 min-w-[35vw] py-14 px-2 shadow-[0_8px_20px_#080f342f] bg-[#fcfcfc] top-0 right-0 min-h-screen'>
      ...
      <div className="mb-10 flex">
        ...
        <Image src="/SamsungGalaxyA50-A.webp" width={100} height={100} className="min-w-32 min-h-24 rounded-[30px] " alt='product image'/>
        </div>
        <div className="right">
          ...
          <input type="text" className='w-10 text-center' />
